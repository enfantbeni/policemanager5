...
import com.belife.policemanager.helper.CreationIdentifiantUtilisateur;
...
//		rolesRepository.saveAll(roles);
    ...
    public String accueilDeux(Model model, HttpSession session) { 
		...
		model.addAttribute("accueilAdmin", "accueilAdmin");
		model.addAttribute("cheminAccueil", "Accueil >");
		CreationIdentifiantUtilisateur identifiantUtilisateur=new CreationIdentifiantUtilisateur();
		String identifiant=identifiantUtilisateur.IdentifiantUser();
